...
The DS1307 is not a precision clock. It can drift by up to  +/-2 seconds a day, which is worsened if the temperature is very variable. So at the very least, you'll need to set the time just before deploying it. Ideally you would reset it every few weeks (there is a more accurate clock, called the ChronoDot, available - see \url{https://www.adafruit.com/product/255}).
